...
int main() {
	...
	while (1)
	{
		...
		if (left_sensor_data == 0)
		{
			if (middle_sensor_data == 0)
			{
				/* Should turn left */
				pulse_width_M1 -= 20;
				pulse_width_M2 += 40;
		...
		/* Motor 1 */
		if (pulse_width_M1 > 90)
		{
			pulse_width_M1 = 90;
		}
		else if (pulse_width_M1 < 30)
		{
			pulse_width_M1 = 30;
		}
		/* Motor 2 */
		if (pulse_width_M2 > 90)
		{
			pulse_width_M2 = 90;
		}
		else if (pulse_width_M2 < 30)
		{
			pulse_width_M2 = 30;
		}
